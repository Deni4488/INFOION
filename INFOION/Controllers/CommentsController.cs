...
namespace INFOION.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public IActionResult Index(int? Id)
        {
            ...
            ViewData["UserId"] = new SelectList(_con.Users, "Id", "Name").ToList().Where(id => id.Value == userId);
            ViewData["ArticleId"] = new SelectList(_con.Articles, "Id", "Name").ToList().Where(id => id.Value == Id.ToString());
            return View();
        }
        [HttpPost]
